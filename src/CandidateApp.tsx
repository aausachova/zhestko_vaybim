...
import { Bell, X, Calendar, CheckCircle, AlertCircle, LogOut } from 'lucide-react';
...
export function CandidateApp({ username, token, onSignOut }: CandidateAppProps) {
  const [userRole] = useState<UserRole>('debtor');
    ...
    <div className="flex h-screen bg-[#F5F7FA]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="flex items-center gap-6">
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-sm">{username || 'Кандидат'}</span>
        ...
        <main className="flex-1 overflow-auto">
          ...
          {currentPage === 'selections' && <SelectionsPage token={token} />}
